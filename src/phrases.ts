// export const oldphrases: string[] = [
...
export const phrases : string[] = [
    `something with the vibe of an 80's diner`,
    `a happy, romantic movie`,
    `movies with "Interstellar" vibes`,
    `movies that will make you feel like sunshine on a cloudy day`,
